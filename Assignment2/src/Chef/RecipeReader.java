...
public class RecipeReader implements RecipeProvider {
     ...
     */
    @Override
    public synchronized Recipe getRecipeById(String id) throws FileNotFoundException, IllegalStateException {
        String line = null;
        try {
            Recipe recipe = null;
     ...
     */
    @Override
    public synchronized Recipe getRecipeByName(String name)
     ...
     */
    @Override
    public synchronized void updateRecipe(Recipe recipe)
            throws FileNotFoundException, IllegalStateException {
        String line = null;
        try {
